...
public class AlojamientoGatewayImpl implements AlojamientoGateway {
    ...
    private String subirImagen(MultipartFile archivo) throws IOException {
        ...
        String rutaDestino = "ruta/donde/guardar/imagenes/" + archivo.getOriginalFilename();
        File destino = new File(rutaDestino);

        // Guardar el archivo en el sistema
        archivo.transferTo(destino);

        return rutaDestino; // O construye una URL según tu configuración
    }
    ...
    public void crearNuevaHabitacion(AlojamientoDTO alojamientoDTO) throws MessagingException, jakarta.mail.MessagingException {
        ...
        if (propietario.getEstadoPropietario().intValue() != 1) {
            throw new IllegalArgumentException("El propietario no está activo.");
        }
